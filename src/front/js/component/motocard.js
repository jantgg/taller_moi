...
export const Motocard = (content) => {
  ...
  return (
    <div
      id="moto-card"
      className="col-12 col-sm-12 col-md-11	col-lg-6	col-xl-6	col-xxl-4 mx-auto my-5"
    >
      <div className="col-12 col-sm-12 col-md-11	col-lg-11	col-xl-11	col-xxl-11 mx-auto d-flex flex-column motocard px-0">
        ...
        >
          ...
          <div id="grey-btns" className="col-12 d-flex mt-3">
            {/* <div className="motocard-btn py-1 px-2 me-2">{bike.type_moto}</div> */}
            <div className="motocard-btn py-1 px-2 me-2">{bike.year}</div>
        ...
        {isLoggedIn && <button onClick={handleDelete}>Borrar</button>}
      </div>
    </div>
  );
};
